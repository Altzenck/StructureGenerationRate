package dev.dexuby.structuregenerationrate.branch.v1_14_R1;
...
import dev.dexuby.structuregenerationrate.branch.v1_14_R1.config.StrongholdStructureConfiguration;
import dev.dexuby.structuregenerationrate.branch.v1_14_R1.config.StructureConfiguration;
...
public class PlacementLoader implements IPlacementLoader {
    ...
    static {
        translator.put("stronghold", new String[]{"e", "f", "g"}); // distance, count, spread
        translator.put("village", new String[]{"a", "b"});
        translator.put("monument", new String[]{"c", "d"});
        translator.put("desert_pyramid", new String[]{"h", "i"});
        translator.put("ocean_ruin", new String[]{"j", "k"});
        translator.put("endcity", new String[]{"l", "m"});
        translator.put("shipwreck", new String[]{"n", "o"});
