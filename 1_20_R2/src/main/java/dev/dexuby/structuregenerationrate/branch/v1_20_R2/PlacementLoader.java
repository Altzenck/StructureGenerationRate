package dev.dexuby.structuregenerationrate.branch.v1_20_R2;
...
import dev.dexuby.structuregenerationrate.branch.v1_20_R2.config.ConcentricRingsStructureConfiguration;
import dev.dexuby.structuregenerationrate.branch.v1_20_R2.config.RandomSpreadStructureConfiguration;
    ...
    public void load() {
        ...
        for (final World world : Bukkit.getServer().getWorlds()) {
            ...
            for (Map.Entry<ResourceKey<StructureSet>, Holder.Reference<StructureSet>> entry : new ArrayList<>(byKeyRef.get().entrySet())) {
                ...
                ReflectionUtils.getDeclaredField(ChunkGeneratorStructureState.class, generatorState, "f").cast(Map.class).clear(); // placementsForStructure
                ReflectionUtils.getDeclaredField(ChunkGeneratorStructureState.class, generatorState, "g").cast(Map.class).clear(); // ringPositions
